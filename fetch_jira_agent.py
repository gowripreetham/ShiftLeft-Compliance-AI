...
def handle_github_action(issue_summary: str, description: str, risk: str, pr_number: Optional[int] = None):
    """
    Hybrid GitHub action:
    - HIGH risk → create a GitHub Issue.
    ...
    body_text = (
        ...
        f"**Details:**\n{description}\n\n"
        f"_This was automatically generated by the Fetch.ai Compliance Agent._"
    )
    ...
    # 🟨 MEDIUM or LOW risk → Comment on PR
